...
public class MyITCenter {
	...
	public void init() {
		Lecturer l1 = new Lecturer("Pham Van Tinh", new GregorianCalendar(1970,
				11, 20).getTime(), "PhD");
				Lecturer l2 = new Lecturer("Mai Anh Tho", new GregorianCalendar(1979, 12,
				24).getTime(), "MS");
				Lecturer l3 = new Lecturer("Nguyen Duc Cong Song", new GregorianCalendar(
				1977, 8, 14).getTime(), "MS");
				lecturers.add(l1);
				lecturers.add(l2);
				lecturers.add(l3);
				...
				courses.add(c3);
				courses.add(c4);
				Student s1 = new Student("Nguyen Van Tuan", new GregorianCalendar(1988,
				1, 23).getTime());
				Student s2 = new Student("Tran Van Thiet", new GregorianCalendar(1989,
				11, 2).getTime());
				Student s3 = new Student("Nguyen Thi Lan", new GregorianCalendar(1988, 6,
				20).getTime());
				Student s4 = new Student("Nguyen Thi Truc", new GregorianCalendar(1990,
				4, 15).getTime());
				Student s5 = new Student("Vo Tan Doi",
				new GregorianCalendar(1988, 2, 26).getTime());
				Student s6 = new Student("Do The Sang",
				new GregorianCalendar(1989, 3, 12).getTime());
				students.add(s1);
				students.add(s2);
				students.add(s3);
				students.add(s4);
	...
	public List<Student> getStudentsOfCourse(Course c){
		...
		for (Student student : students) {
			for (Register r: student.getCourseRegister()) {
