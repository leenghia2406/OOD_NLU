...
public class KHThanhToanTMTren1Trieu extends KhachHang {
	
	public KHThanhToanTMTren1Trieu(String maKH, String tenKH, int diemTichLuy, Date ngaySinh, List<SanPham> dsSanPham) {
